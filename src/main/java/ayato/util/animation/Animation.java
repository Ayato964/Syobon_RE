...
import ayato.util.ActionString;
import ayato.util.MessageSup;
import ayato.util.TickRegistory;
import ayato.util.function.IsBoolInterface;
...
public abstract class Animation implements Serializable {
    ...
    public static class Properties{
        ...
        public Properties frame(Color c){
            prop.add(new ayato.util.animation.Frame(c));
            return this;
        }
        public Properties frame(Color c, IsBoolInterface b){
            prop.add(new ayato.util.animation.Frame(c, b));
            return this;
        }
        public Properties frame(Color c, int w, int h, IsBoolInterface b){
            prop.add(new ayato.util.animation.Frame(c, w, h, b));
            return this;
        }
